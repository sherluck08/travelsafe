...
class MigrationInfo(object):
    ...
    def __init__(
        ...
        self.up_revision_id = self.up_revision_ids[0] if self.up_revision_ids else None
...
class RevisionStep(MigrationStep):
    ...
    def merge_branch_idents(self, heads):
        ...
        return list(from_revisions[:-1]), from_revisions[-1], self.to_revisions[0]
    ...
    def unmerge_branch_idents(self, heads):
        ...
        return self.from_revisions[0], to_revisions[-1], to_revisions[:-1]
    ...
    def should_create_branch(self, heads):
        ...
        return bool(downrevs and not heads.intersection(downrevs) or not downrevs)
...
class StampStep(MigrationStep):
    ...
    def merge_branch_idents(self, heads):
        return list(self.from_[:-1]), self.from_[-1], self.to_[0]

    def unmerge_branch_idents(self, heads):
        return self.from_[0], self.to_[-1], list(self.to_[:-1])
